 ...
 */
package br.com.oxxy.compresslibrary.format;

import android.media.MediaCodecInfo;
import android.media.MediaFormat;

class Android16By9FormatStrategy implements br.com.oxxy.compresslibrary.format.MediaFormatStrategy {
    ...
    public MediaFormat createVideoOutputFormat(MediaFormat inputFormat) {
        ...
        if (longer * 9 != shorter * 16) {
            throw new br.com.oxxy.compresslibrary.format.OutputFormatUnavailableException("This video is not 16:9, and is not able to transcode. (" + width + "x" + height + ")");
        }
    ...
    public MediaFormat createAudioOutputFormat(MediaFormat inputFormat) {
        ...
        final MediaFormat format = MediaFormat.createAudioFormat(br.com.oxxy.compresslibrary.format.MediaFormatExtraConstants.MIMETYPE_AUDIO_AAC,
