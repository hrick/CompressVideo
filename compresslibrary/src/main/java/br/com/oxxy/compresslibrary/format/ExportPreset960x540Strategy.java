...
*/
class ExportPreset960x540Strategy implements br.com.oxxy.compresslibrary.format.MediaFormatStrategy {
    ...
    public MediaFormat createVideoOutputFormat(MediaFormat inputFormat) {
        ...
        MediaFormat outputFormat = br.com.oxxy.compresslibrary.format.MediaFormatPresets.getExportPreset960x540(width, height);
